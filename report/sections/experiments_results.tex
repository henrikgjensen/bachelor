...
\textbf{Note}: In the tests that follows, the \textit{Jackson-Weiss syndrome} will occur twice in all the case - hence producing 30 instead of 29 diseases. 
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.1\textwidth]{clusters/sum_stem_top20_best_cat_scratch_disease_v2.jpg}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.1\textwidth]{clusters/sum_stem_top20_worst_developmental_dysplasia_of_hip_v2.jpg}
  \end{center}
