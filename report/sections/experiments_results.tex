...
cluster as \textit{Cat Scratch} requires the merging of the entire cluster. \fxnote{kan skrives lidt bedre - fx hvad er 'merging'?}
...
We have also chosen to cluster the disease where sum measure on the stemmed 
...
597. So it is not possible to find it in the dendrogram, our systems \fxnote{opremsning - So..,our..,done}
