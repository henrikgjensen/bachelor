...
The name of the file --- that each of the data sets are stored in --- is the
...
\texttt{gatherOfAllThings} completes by performing a write out of the MedLine
...
The \textit{PubMedSIR} module uses the following auxiliary modules (see
