...
histogrammer\fxnote{REF: til histogram-sammenlignings-tests af label
  og term-doc}), the disease matrix does not score that far from the
...
The TermDoc module uses the following auxillary modules (see section
\ref{AuxModules}):
...
needs to be dealt with locally \fxnote{As mentioned in}. Before
