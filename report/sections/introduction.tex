...
\cite{Rarediseases}). Some of these \fxnote{fix - some of these disases} diseases might not be fatal if
...
cases come from a blind test provided by Henrik L. J\o rgensen.\\ \fxnote{tilfoej lennart hvis han kommer med noget}
...
Chapter \ref{Background} covers the different \fxnote{fix areas} areas
that we harvest our data from and how we intend to \fxnote{Model
  what?} model it. It provides a background on Rarediseases.info,
