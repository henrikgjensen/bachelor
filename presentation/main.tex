...
\begin{frame}
  ...
  \visible<1->{Acropectorovertebral dysplasia information er baseret p\aa\ en MedLine Record.}

  \visible<2->{Der er brug for mere diversitet i termerne / flere synonymer for symptomer}

  \visible<3->{Der mangler noget her!!!}
